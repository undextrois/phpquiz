...
if($_SERVER['HTTP_HOST'] == '192.168.0.13' || $_SERVER['HTTP_HOST'] == '202.73.163.110'){
  ...
  $_alto_config['db']['user']     = "r";
  $_alto_config['db']['pass']     = "ukpauser";
}
else{
*/
  $_alto_config['db']['host']     = "localhost";
  $_alto_config['db']['database'] = "webman_webomancer";
  $_alto_config['db']['user']     = "webman_root";
...
$_alto_config['root-dir']       = "/_rebuild/";
