...
include('inc/header.inc.php'); 
	...
	if (isset($HTTP_SESSION_VARS['scoreboard'])) 
	{
			...
			echo "<p id=\"hornav\"><a href=\"results.php?useridPK=".$_GET['useridPK']."\">View Results Sheet</a></p>";

	}
?>
<h2>&nbsp;</h2>
<p><font size="3" face="Verdana, Arial, Helvetica, sans-serif">WEBOMANCER TEST ZONE</font></p>
